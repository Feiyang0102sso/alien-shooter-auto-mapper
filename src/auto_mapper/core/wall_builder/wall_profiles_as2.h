...
inline constexpr CeilingCurtainProfile CEILING_CURTAIN_AS2_SET1 = {
    ...
    .keep_dir_b_long_at_right_deep_corner = true,
    .upper_left_deep_corner_dir_a = {DeepCornerCurtainAction::DeleteOnly, 0.00f},
    .upper_right_deep_corner_dir_a = {DeepCornerCurtainAction::DeleteAndReplace, 0.50f},
    .lower_left_deep_corner_dir_a = {DeepCornerCurtainAction::DeleteOnly, 0.00f},
    .lower_right_deep_corner_dir_a = {DeepCornerCurtainAction::DeleteOnly, 0.00f},
